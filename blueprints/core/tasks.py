# tasks.py
"""
Заявки: список, детали, создание, обновление, закрытие, удаление.

Массовые операции — в tasks_bulk.py
Фильтры — в tasks_filters.py
...
# ============================================================
# КЕШ — публичная функция, используется в tasks_bulk.py
# ============================================================

def invalidate_task_caches():
    """Сброс кешей, зависящих от заявок."""
    try:
